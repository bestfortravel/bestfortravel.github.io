  ...
  return (
    <div className='wrapper post-container'>
      <div className='post-header'>
        ...
        <Link className='check-posts-button' href='/feed'>
          <div className='check-posts-text'>Check all posts</div>
          <svg
            width='24'
            height='25'
            viewBox='0 0 24 25'
      ...
      <div className='post-content'>
        ...
        <div className='post-body'>
          ...
          <div className='post-location'>Paris, France</div>

          <div className='post-images'>
            <img
              src='/images/PostImage1.png'
              alt='Post image 1'
              className='post-image post-image-1'
            />
            <img
              src='/images/PostImage2.png'
              alt='Post image 2'
              className='post-image post-image-2'
            />
            <img
              src='/images/PostImage3.png'
              alt='Post image 3'
              className='post-image post-image-3'
            />
          </div>
          ...
          <div className='post-engagement'>
            {[
              { icon: 'eye-icon', count: 320 },
              { icon: 'like-icon liked', count: 250 },
              { icon: 'comment-icon', count: 12 },
              { icon: 'share-icon', count: 3 },
            ].map((item, i) => (
              <div key={i} className='engagement-item'>
                <div className={item.icon}></div>
                <div className='engagement-count'>{item.count}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className='comment-input'>
        <div className='comment-placeholder'>Comment your thoughts</div>
        <svg
          width='24'
          height='24'
          viewBox='0 0 24 24'
