...
export default function TravelHighlights({ videos = [] }: TravelHighlightsProps) {
  ...
  useEffect(() => {
    const handleEsc = (e: KeyboardEvent) => e.key === 'Escape' && closeFullScreen();
                    ...
                    <div className='highlights-video-info'>
                      <div className='highlights-author'>
                        ...
                        <div className='highlights-author-info'>
                          ...
                          <p className='highlights-author-travel-location'>
                            {video.location}
                          </p>
                        </div>
                      </div>
                  ...
                  <div className='fullscreen-video-section'>
                    <div className='fullscreen-video-section-inner'>
                      ...
                      <div className='video-stats-row'>
                        ...
                        <div className='video-stats-item'>
                          <img src='/icons/chat-full-grey.svg' alt='' /> {videos[activeVideo].comments}
                        </div>
                        <div className='video-stats-item'>
                          <img src='/icons/share-full-grey.svg' alt='' /> {videos[activeVideo].shares}
                        </div>
                      </div>
                      <button
