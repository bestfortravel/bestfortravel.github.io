      ...
      <div className="auth-card">
        ...
        <form className="auth-form" onSubmit={handleSubmit} noValidate>
          ...
          <div className={`password-wrapper ${showPassword ? 'show' : ''}`}>
            ...
            <div className={`password-rules ${passwordFocused ? 'visible' : ''}`}>
              <p className="password-rules-title">Password must include:</p>
              <ul>
                <li className={`password-rules-item ${requirements.length ? 'valid' : 'invalid'}`}>
                  <span className="password-rules-icon"></span> 6–12 Characters
                </li>
                <li className={`password-rules-item ${requirements.capital ? 'valid' : 'invalid'}`}>
                  <span className="password-rules-icon"></span> At least one capital letter
                </li>
                <li className={`password-rules-item ${requirements.number ? 'valid' : 'invalid'}`}>
                  <span className="password-rules-icon"></span> At least one number
                </li>
                <li className={`password-rules-item ${requirements.spaces ? 'valid' : 'invalid'}`}>
